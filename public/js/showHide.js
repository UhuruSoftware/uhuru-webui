...
function showSpaces()
{
        ...
        document.getElementById('domains_btn_link').style.paddingBottom = '0px';
        document.getElementById('domains_btn_link').style.borderTop = '0px solid #0e4769';
        document.getElementById('domains_btn_link').style.borderLeft = '0px solid #0e4769';
        document.getElementById('domains_btn_link').style.borderRight = '0px solid #0e4769';
        document.getElementById('domains_btn_link').style.color = "#ffffff";
...
function showMembers()
{
    ...
    document.getElementById('add_credit_card').style.display = 'block';
...
function showDomains()
{
    ...
    document.getElementById('domains_btn_link').style.paddingBottom = '1px';
    document.getElementById('domains_btn_link').style.borderTop = '1px solid #0e4769';
    document.getElementById('domains_btn_link').style.borderLeft = '1px solid #0e4769';
    document.getElementById('domains_btn_link').style.borderRight = '1px solid #0e4769';
    document.getElementById('domains_btn_link').style.backgroundColor = '#09293e';
    document.getElementById('domains_btn_link').style.color = "#ffffff";
    ...
    document.getElementById('domains').style.display = 'block';
    document.getElementById('create_space_btn').style.display = 'none';
    document.getElementById('add_credit_card').style.display = 'none';
    document.getElementById('add_user_btn_owner').style.display = 'none';
...
function showApps()
{
        ...
        document.getElementById('routes_li').style.paddingBottom = '0px';
        document.getElementById('routes_li').style.borderTop = '0px solid #0e4769';
        document.getElementById('routes_li').style.borderLeft = '0px solid #0e4769';
        document.getElementById('routes_li').style.borderRight = '0px solid #0e4769';
        document.getElementById('routes_li').style.color = "#ffffff";
...
function showRoutes()
{
    document.getElementById('routes_li').style.paddingBottom = '1px';
    document.getElementById('routes_li').style.borderTop = '1px solid #0e4769';
    document.getElementById('routes_li').style.borderLeft = '1px solid #0e4769';
    document.getElementById('routes_li').style.borderRight = '1px solid #0e4769';
    document.getElementById('routes_li').style.backgroundColor = '#09293e';
    document.getElementById('routes_li').style.color = "#ffffff";
